...
Con esto, se logró solucionar la divergencia de los agentes y se realizó la primera ejecución del algoritmo exitosa utilizando dos agentes, sin obstáculos y una meta en la esquina, tal como se observa en la Figura \ref{fig:prueba_fisico1}. Las imágenes en el orden de izquierda a derecha y luego de arriba hacia abajo muestran la secuencia de ejecución del algoritmo donde el líder se dirige hacia la meta y la formación lo sigue durante todo el trayecto.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{replicar_fisico_pruebas/prueba_fisico_p1v2.png}
...
Una vez realizada la primera prueba en físico, se simuló un escenario arbitrario en Webots con el fin de verificar el funcionamiento del nuevo control proporcional en un ambiente simulado, sin embargo, se encontró que ahora la simulación presentaba los mismos patrones de divergencia en todas las etapas del algoritmo... ARGUMENTAR
