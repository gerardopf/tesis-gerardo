...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.2\textwidth]{optimizacion/diagrama_supervisor.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.35\textwidth]{optimizacion/diagrama_agentes.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{replicar_fisico_pruebas/agente_inmovil_p1.png}
	\includegraphics[width=0.6\textwidth]{replicar_fisico_pruebas/agente_inmovil_p2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{replicar_fisico_pruebas/divergencia_p1.png}
	\includegraphics[width=0.6\textwidth]{replicar_fisico_pruebas/divergencia_p2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{replicar_fisico_pruebas/divergencia2_p1.png}
	\includegraphics[width=0.6\textwidth]{replicar_fisico_pruebas/divergencia2_p2.png}
