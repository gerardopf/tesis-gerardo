...
desfases_file = 'calibracion_markers_inicial.npy' # desfases de markers en quaterniones

NMax = 10  # número máximo de agentes que la formación puede tener
NStart = 5 # primer agente
N = 6	# último agente

""" obstáculos y objetivo """
obj_marker = 12        # marker del objetivo 

obs_active = 0        # 0: SIN obstáculos | 1: CON obstáculos
obs_start_marker = 10 # marker del primer obstáculo
...
setup_shape = 1         # 0: posición inicial LÍNEA | 1: posición inicial CÍRCULO
...
""" obstáculos """
cantO = 3  # cantidad de obstáculos a usar
...
while supervisor.step(TIME_STEP) != 1:
    ...
    if (fisico == 1):
        ...
        try:
            ...
            print("MAIN LOOP ERROR: Error al obtener poses de agentes")
    ...
    # ETAPA 0 -----> COLOCARSE EN POSICIONEES INICIALES
    if (cambio == 0):
        ready_ini_pos = 0
        cont_N = 0
