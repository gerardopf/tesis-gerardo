...
# FÍSICO - robotat
    ...
    robot = Robot()
    argc = int(robot.getCustomData()) # número de agente
    agente = argc + 1 # hacer coincidir el índice de listas de python y matlab
    ...
    if (NStart <= agente <= N): 
        try:
            ...
            print("error al conectar con el agente No. ", argc)
            pass
    robot.step(TIME_STEP)    
    ...
    while robot.step(TIME_STEP) != -1:
        ...
        if (NStart <= agente <= N):
            try:
                ...
                print("error al enviar velocidades al agente No. ", argc)
                pass
        ...
        if keyboard.is_pressed('a'):
            if (NStart <= agente <= N):    
                try:
                    ...
                    print("error al detener y desconectar el agente No. ", argc)
                    pass
            break
        pass