...
Se eliminó el agent setup y se dejó solo la opción 5
...
initial_conditions_file = 'trial0.npz' # condiciones iniciales (.npz) simular la corrida en físico
...
obs_start_marker = obs_marker_list[0] # marker del primer obstáculo
