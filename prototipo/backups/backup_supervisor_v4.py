...
initial_conditions_file = 'finaltrial_6A_AAA_f_1.npz' # select the initial conditions file (.npz) to compare the physical run to simulation
...
# Formation Matrix
form_shape = 2    # 1: triangle 2: long hexagon
