...
# Modificado por Gerardo Paz Fuentes
...
archivo = 'Final_4A_moviles_f_26.npz'
show_images = 0
...
fig_size_1x_traj = 0.8
fig_size_3x_traj = 0.32

fig_size_1x_graph = 0.5
fig_size_2x_graph = 0.49

def print_latex_figure(filename, caption, label, width):
    latex_code = f"""
\\begin{{figure}}[H]
    \\centering
    \\includegraphics[width={width}\\textwidth]{{/{main_folder}/{folder_name}/{filename}}}
    \\caption{{{caption}}}
    \\label{{fig:{label}}}
\\end{{figure}}
"""
    # Open a text file in append mode ('a')
    with open(f'{main_folder}/{folder_name}/latex.txt', 'a') as file:
...
\\begin{{figure}}[H]
    \\centering
    \\includegraphics[width={width}\\textwidth]{{/{main_folder}/{folder_name}/{filename1}}}
    \\includegraphics[width={width}\\textwidth]{{/{main_folder}/{folder_name}/{filename2}}}
    \\caption{{{caption}}}
    \\label{{fig2:{label}}}
\\end{{figure}}
"""
...
def print_latex_figure_three(filename1,filename2,filename3, caption, label, width):
    latex_code = f"""
\\begin{{figure}}[H]
    \\centering
    \\includegraphics[width={width}\\textwidth]{{/{main_folder}/{folder_name}/{filename1}}}
    \\includegraphics[width={width}\\textwidth]{{/{main_folder}/{folder_name}/{filename2}}}
    \\includegraphics[width={width}\\textwidth]{{/{main_folder}/{folder_name}/{filename3}}}
    \\caption{{{caption}}}
    \\label{{fig3:{label}}}
\\end{{figure}}
"""
...
filename_without_extension = archivo.split('.')[0] # Extracting the filename without extension from 'archivo'
...
if match:
    ...
    print(f"match: {extracted_value}")
else:
    print("not extracted match value")

match_number = re.search(pattern_number, filename_without_extension)
if match_number:
    extracted_number = match_number.group(1)
    print(f"match number: {extracted_number}")
else:
    print("not extracted match number")

""" --------------- DEFINIR FOLDERS PRINCIPAL Y SECUNDARIO PARA GUARDADO DE ARCHIVOS ---------------"""

main_folder = 'graficas_finales' # Folder principal
folder_name = f'escenario_{extracted_number}' # Folder para cada corrida
...
trial_folder = os.path.join(main_folder, folder_name) # Define the trial folder name

# Create the trial folder inside the main folder
if not os.path.exists(trial_folder):
    os.makedirs(trial_folder)

with open(f'{main_folder}/{folder_name}/latex.txt', 'w') as file:
    pass
...
plt.xlabel('Eje x (m)')
plt.ylabel('Eje y (m)')
plt.title(f'Trayectorias de agentes y obstáculos en {texto_fisico}')
...
# Save the plot
plt.savefig(f'{main_folder}/{folder_name}/traj_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/traj_{filename_without_extension}.png', format='png', bbox_inches='tight')
print_latex_figure(f'traj_{filename_without_extension}.eps', f'Trayectorias de los {agent_number} agentes y {obs_number} obstáculos en el '+ f'{virtualtext}.', f'escenario{extracted_number}_trajTodos', f'{fig_size_1x_traj}')
...
plt.xlabel('Eje x (m)')
plt.ylabel('Eje y (m)')
plt.title(f'Trayectorias de agentes en {texto_fisico}')
...
# Save the plot
plt.savefig(f'{main_folder}/{folder_name}/traj_agents_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/traj_agents_{filename_without_extension}.png', format='png', bbox_inches='tight')
print_latex_figure(f'traj_agents_{filename_without_extension}.eps', f'Trayectorias de los {agent_number} agentes en el '+ f'{virtualtext}.', f'escenario{extracted_number}_trajAgentes', f'{fig_size_1x_traj}')
...
plt.xlabel('Eje x (m)')
plt.ylabel('Eje y (m)')
plt.title(f'Trayectorias de obstáculos en {texto_fisico}')
...
# Save the plot
plt.savefig(f'{main_folder}/{folder_name}/traj_obs_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/traj_obs_{filename_without_extension}.png', format='png', bbox_inches='tight')
print_latex_figure(f'traj_obs_{filename_without_extension}.eps', f'Trayectoria de los {obs_number} obstáculos en el '+ f'{virtualtext}.', f'escenario{extracted_number}_trajObstaculos', f'{fig_size_1x_traj}')
    
print_latex_figure_three(f'traj_agents_{filename_without_extension}.eps', f'traj_obs_{filename_without_extension}.eps', f'traj_{filename_without_extension}.eps', f'Trayectorias de los {agent_number} agentes y {obs_number} obstáculos en el {virtualtext}', f'escenario{extracted_number}_trajTodos', f'{fig_size_3x_traj}')
...
# centro de masa de la formación
...
# Save the plot
plt.savefig(f'{main_folder}/{folder_name}/cm_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/cm_{filename_without_extension}.png', format='png', bbox_inches='tight')
print_latex_figure(f'cm_{filename_without_extension}.eps', "Trayectoria del centro de masa de la formación en el "+ f'{virtualtext}.', f'escenario{extracted_number}_cm', f'{fig_size_1x_traj}')
...
plt.savefig(f'{main_folder}/{folder_name}/normV_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/normV_{filename_without_extension}.png', format='png', bbox_inches='tight')

""" ---------- Gráficar error cuadrático medio de la formación ---------- """
plt.figure()
...
plt.savefig(f'{main_folder}/{folder_name}/mse_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/mse_{filename_without_extension}.png', format='png', bbox_inches='tight')
print_latex_figure_two(f'normV_{filename_without_extension}.eps',f'mse_{filename_without_extension}.eps', "Historial de la norma de velocidad y error cuadrático medio de la formación en el "+ f'{virtualtext}.', f'escenario{extracted_number}_normVmse', f'{fig_size_2x_graph}')
...
plt.grid()
plt.savefig(f'{main_folder}/{folder_name}/vel_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/vel_{filename_without_extension}.png', format='png', bbox_inches='tight')
print_latex_figure(f'vel_{filename_without_extension}.eps', "Historial de las velocidades de los agentes en el "+ f'{virtualtext}.', f'escenario{extracted_number}_vel', f'{fig_size_1x_graph}')
...
plt.savefig(f'{main_folder}/{folder_name}/xvel_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/xvel_{filename_without_extension}.png', format='png', bbox_inches='tight')
...
plt.savefig(f'{main_folder}/{folder_name}/yvel_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/yvel_{filename_without_extension}.png', format='png', bbox_inches='tight')
print_latex_figure_two(f'xvel_{filename_without_extension}.eps',f'yvel_{filename_without_extension}.eps', "Historial de velocidades de los agentes en el "+ f'{virtualtext}.', f'escenario{extracted_number}_xyvel', f'{fig_size_2x_graph}')
...
plt.savefig(f'{main_folder}/{folder_name}/phiR_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/phiR_{filename_without_extension}.png', format='png', bbox_inches='tight')
...
plt.savefig(f'{main_folder}/{folder_name}/phiL_{filename_without_extension}.eps', format='eps', bbox_inches='tight')
plt.savefig(f'{main_folder}/{folder_name}/phiL_{filename_without_extension}.png', format='png', bbox_inches='tight')
print_latex_figure_two(f'phiL_{filename_without_extension}.eps',f'phiR_{filename_without_extension}.eps', "Historial de velocidades en las ruedas de los agentes en el "+ f'{virtualtext}.', f'escenario{extracted_number}_phiLR', f'fig_size_2x_graph')
...
""" ---------- Crear animación de trayectorias ---------- """
...
output_gif_filename = f'{main_folder}/{folder_name}/animation_{filename_without_extension}.gif'
