...
data = np.load('10sepProto3obs_3A_NNN_f_0.npz')
print(data.files)
#print(data)
...
plt.plot(x_positions[graphCycleStart:,NStart:N], y_positions[graphCycleStart:,NStart:N], linestyle='--', zorder=4, label=labels)
plt.scatter(x_positions[graphCycleStart,NStart:N], y_positions[graphCycleStart,NStart:N], marker='o', facecolor='none', edgecolor='green', label='Pos Iniciales', zorder=5, s = diam_agente/factor_m)
