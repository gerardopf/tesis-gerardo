...
""" 
Ya se puede elegir qué agentes usar, obstáculos y objetivo
- Queda pendiente revisar si los obstáculos se pueden colocar como marcadores no consecutivos
- El algoritmo aún se queda en la etapa 0
    No converge
    Todos se mueven hacie enfrente y algunos comienzan a girar
    No evade obstáculos al moverse
"""
