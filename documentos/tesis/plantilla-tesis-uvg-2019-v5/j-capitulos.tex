...
\subsubsection{Medición del tiempo de ejecución del algoritmo}
...
\subsubsection{Monitoreo de variables}
Pr último, con el fin de monitorear el comportamiento del algoritmo durante su ejecución, se añadió la visualización en la terminal de Webots de los siguientes factores:
...
\subsubsection{Visualización en tiempo real en Webots del escenario}
...
\subsection{Verificación del rendimiento del algoritmo optimizado}
...
Para esto, se utilizó el escenario de la Figura \ref{label} para realizar corridas con $2$, $3$, $4$ y $5$ agentes donde se midió el tiempo... FALTA
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|llcc|}
		...
		\multirow{3}{*}{\textbf{2}}       & 1                                 & \multicolumn{1}{l|}{72.846}                    & \multicolumn{1}{l|}{0.36}                                   & \multicolumn{1}{c|}{\multirow{3}{*}{72.1267}}           & \multirow{3}{*}{1.9777}          \\ \cline{2-4}
		...
		\multirow{3}{*}{\textbf{3}}       & 1                                 & \multicolumn{1}{l|}{82.828}                    & \multicolumn{1}{l|}{0.386}                                  & \multicolumn{1}{c|}{\multirow{3}{*}{86.4270}}           & \multirow{3}{*}{6.7963}          \\ \cline{2-4}
		...
		\multirow{3}{*}{\textbf{4}}       & 1                                 & \multicolumn{1}{l|}{79.064}                    & \multicolumn{1}{l|}{0.428}                                  & \multicolumn{1}{c|}{\multirow{3}{*}{78.7760}}           & \multirow{3}{*}{1.9302}          \\ \cline{2-4}
		...
		\multirow{3}{*}{\textbf{5}}       & 1                                 & \multicolumn{1}{l|}{112.28}                    & \multicolumn{1}{l|}{0.504}                                  & \multicolumn{1}{c|}{\multirow{3}{*}{143.2237}}          & \multirow{3}{*}{44.0504}         \\ \cline{2-4}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|llcc|}
		...
		&                                   & \multicolumn{1}{c|}{\textbf{Tiempo total (s)}} & \multicolumn{1}{c|}{\textbf{Tiempo de ciclo promedio (ms)}} & \multicolumn{1}{c|}{\textbf{Tiempo total promedio (s)}} & \textbf{Desviación estándar (s)} \\ \hline
		\multirow{3}{*}{\textbf{2}}       & 1                                 & \multicolumn{1}{l|}{69.793}                    & \multicolumn{1}{l|}{133.715}                                & \multicolumn{1}{c|}{\multirow{3}{*}{70.9800}}           & \multirow{3}{*}{2.4460}          \\ \cline{2-4}
		...
		\multirow{3}{*}{\textbf{3}}       & 1                                 & \multicolumn{1}{l|}{113.666}                   & \multicolumn{1}{l|}{129.068}                                & \multicolumn{1}{c|}{\multirow{3}{*}{97.9450}}           & \multirow{3}{*}{13.8863}         \\ \cline{2-4}
		...
		\multirow{3}{*}{\textbf{4}}       & 1                                 & \multicolumn{1}{l|}{107.001}                   & \multicolumn{1}{l|}{167.707}                                & \multicolumn{1}{c|}{\multirow{3}{*}{112.4807}}          & \multirow{3}{*}{4.7548}          \\ \cline{2-4}
		...
		\multirow{3}{*}{\textbf{5}}       & 1                                 & \multicolumn{1}{l|}{336.836}                   & \multicolumn{1}{l|}{236.169}                                & \multicolumn{1}{c|}{\multirow{3}{*}{335.3777}}          & \multirow{3}{*}{51.8439}         \\ \cline{2-4}
